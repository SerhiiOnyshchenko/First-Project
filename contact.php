...
$header .= "From: Новая заявка <vkhellboy1992@gmail.com>\n\n";	
$mail = mail("vkhellboy1992@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
